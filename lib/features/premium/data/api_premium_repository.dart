...
class ApiPremiumRepository implements PremiumRepository {
  ...
  Future<PremiumStatus> getMyStatus() async {
    ...
    return PremiumStatus(
      ...
      entitlement: entitlementJson == null
          ? null
          : _toEntitlement(entitlementJson),
      entitlements: (body['entitlements'] as List<dynamic>)
          .map((json) => _toEntitlement(json as Map<String, dynamic>))
          .toList(),
      unlockedFeatures: (body['unlocked_features'] as List<dynamic>)
          .cast<String>(),
  ...
  Future<CheckoutResult> checkout(String planCode) async {
    final body =
        await _post('/premium/checkout', {'plan_code': planCode})
  ...
  Future<PremiumPayment> verifyPayment(String paymentId) async {
    final body =
        await _post('/premium/payments/$paymentId/verify', const {})
            as Map<String, dynamic>;
  ...
  Future<List<PremiumPayment>> listMyPayments() async {
    ...
    return body
        .map((json) => _toPayment(json as Map<String, dynamic>))
        .toList();
  }
  ...
  PremiumEntitlement _toEntitlement(Map<String, dynamic> json) =>
      PremiumEntitlement(
        id: json['id'] as String,
  ...
  static EntitlementStatus _entitlementStatusFromWire(String value) =>
      switch (value) {

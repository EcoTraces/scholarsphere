...
void main() {
  ...
  test('getAllForAdministration maps every verification status and stops '
      'once every page has been fetched', () async {
    var requestCount = 0;
    ...
    expect(byId['opp-pending']!.verificationStatus, VerificationStatus.pending);
    expect(
    ...
    expect(byId['opp-expired']!.verificationStatus, VerificationStatus.expired);
    expect(
